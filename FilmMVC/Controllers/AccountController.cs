...
namespace FilmMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if (ModelState.IsValid)
            { //bağlama işlemini burda yapıyoruz
                UserStore<Kullanici> str = new UserStore<Kullanici>(new FilmContext());
                UserManager<Kullanici> mng = new UserManager<Kullanici>(str);

                //burda da asıl account modelini viewModele bağlıyoruz. Viewmodel o kayıt sayfasında görmek isteiğmz şeyler.
                var user = new Kullanici
                {
                    //ama burda bağlaman gerek.
                    UserName = model.Email,
                    Email = model.Email,
                    KullaniciAdi = model.Email,
                    DogumTarihi = model.BirthDay,
                ...
                if (result.Succeeded)
                {
                    //burasını ben de anlamadım kanka duygu hocanın önceki projesinde vardı bu :)
